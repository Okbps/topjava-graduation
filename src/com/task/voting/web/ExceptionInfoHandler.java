...
public class ExceptionInfoHandler {
    ...
    private static Map<String, String> constraintCodeMap = new HashMap<String, String>() {
        {
            put("users_unique_name_idx", "exception.users.duplicate_name");
            put("cafes_unique_name_idx", "exception.cafes.duplicate_name");
        }
    };
            ...
            if (entry.isPresent()) {
                return logAndGetErrorInfo(req,
                        new DataIntegrityViolationException(
                                messageSource.getMessage(entry.get().getValue(), null, null)
                        ), false);
            }
        }
